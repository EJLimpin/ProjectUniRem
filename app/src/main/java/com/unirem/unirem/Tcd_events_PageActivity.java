...
public class Tcd_events_PageActivity extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private RecyclerView TCD_event_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TCD_event_list.setLayoutManager(new LinearLayoutManager(this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_add) {
            ...
            startActivity(new Intent(Tcd_events_PageActivity.this, AddEventActivity.class));
        ...
        if (item.getItemId() == R.id.action_home) {
            ...
            startActivity(new Intent(Tcd_events_PageActivity.this, MainActivity.class));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Events, Tcd_events_PageActivity.EventsviewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Events, Tcd_events_PageActivity.EventsviewHolder>(

                Events.class,
                R.layout.event_row,
                Tcd_events_PageActivity.EventsviewHolder.class,
                mDatabase
        ) {

            @Override
            protected void populateViewHolder(Tcd_events_PageActivity.EventsviewHolder viewHolder, Events model, int position) {
        ...
        TCD_event_list.setAdapter(firebaseRecyclerAdapter);
    }
